...
const CSS = `
  ...
  .sb-logo-icon {
    ...
    background: linear-gradient(135deg, #1a6a36, #25984e);
    display: flex; align-items: center; justify-content: center;
    box-shadow: 0 4px 12px rgba(37,152,78,.4);
  }
  .sb-logo-name {
  ...
  .sb-logo-sub {
    color: rgba(255,255,255,.35); font-size: 10px; white-space: nowrap; margin-top: 1px;
  }
  ...
  .sb-avatar {
    ...
    background: linear-gradient(135deg, #33b560, #1a6a36);
    border: 2px solid rgba(79,208,122,.4);
    display: flex; align-items: center; justify-content: center;
    color: #fff; font-size: 14px; font-weight: 700;
    position: relative;
    box-shadow: 0 0 14px rgba(79,208,122,.2);
  }
  .sb-online {
    ...
    box-shadow: 0 0 6px rgba(79,208,122,.8);
  }
  ...
  .sb-item {
    display: flex; align-items: center; gap: 10;
    padding: 7px 9px; border-radius: 9px; margin-bottom: 1px;
  ...
  .sb-item--active {
    background: linear-gradient(135deg, rgba(26,106,54,.55) 0%, rgba(37,152,78,.28) 100%);
    color: #fff;
    border-color: rgba(79,208,122,.25);
    box-shadow: 0 2px 16px rgba(79,208,122,.12), inset 0 1px 0 rgba(255,255,255,.07);
    font-weight: 600;
  }
  ...
  .sb-icon--active {
    ...
    color: #4fd07a;
    box-shadow: 0 0 10px rgba(79,208,122,.15);
  }
  ...
  .sb-active-pip {
    ...
    box-shadow: 0 0 6px rgba(79,208,122,.7);
  }
  ...
  .sb-logout {
    display: flex; align-items: center; gap: 10;
    padding: 8px 10px; width: 100%; border-radius: 9px;
